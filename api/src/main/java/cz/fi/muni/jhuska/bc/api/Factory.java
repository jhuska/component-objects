...
public class Factory {
    ...
    *to iterate over all annotations methods and invoke them on what ?
    *obviously it is not possible to invoke it on annotation, since it can not be instantiated
    */
